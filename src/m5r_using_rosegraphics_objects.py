...
#            Rendering draws all the objects on the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            If the red X in the upper right hand corner is clicked, all of the boxes go away. However, if you
#           click on the box, only the one you clicked goes away. If the close_on_mouse_click is commented out, the
#           windows rapidly appear and go away without the user doing anything.
#
